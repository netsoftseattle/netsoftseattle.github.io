...
@AUTHURLS = ('www.shansoft.com','shansoft.com');

$TO       = 'support@shansoft.com,shansoftsolutions@yahoo.com';

$SUBJECT  = 'Shansoft Support Request';

$REDIRECT = 'http://www.shansoft.com/hosting/index.php';
